export default function LiveDemoIcon() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      height="24"
      width="24"
      className="fill-blue-500 transition ease-in-out duration-300 hover:fill-blue-600 dark:fill-sky-500 dark:hover:fill-sky-600"
    >
