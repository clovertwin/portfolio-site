        ...
        >
          ...
          <div className="sm:flex sm:space-x-4 ">
            <div className="sm:w-1/2">
              ...
              <input
                ...
                className="border-2 border-blue-400 bg-white rounded-md w-full block py-2 px-4 text-neutral-500 text-base focus:outline-none focus:border-blue-600 dark:border-sky-500 dark:bg-neutral-500 dark:text-neutral-50"
                type="text"
                name="user_name"
              />
            </div>
            <div className="mt-6 sm:mt-0 sm:w-1/2">
              ...
              <input
                ...
                className="border-2 border-blue-400 bg-white rounded-md w-full block py-2 px-4 text-base text-neutral-500 focus:outline-none focus:border-blue-600 dark:border-sky-500 dark:bg-neutral-500 dark:text-neutral-50"
                type="email"
                name="user_email"
              />
            </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows="4"
              className="border-2 border-blue-400 bg-white rounded-md block py-2 px-4 text-base text-neutral-500 w-full focus:outline-none focus:border-blue-600 dark:border-sky-500 dark:bg-neutral-500 dark:text-neutral-50"
              name="message"
            />
          </div>
