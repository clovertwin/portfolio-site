...
export default function Project({
  ...
  return (
    <div
      ...
      } bg-white rounded-2xl p-4 shadow-lg border-2 border-blue-600 sm:border-white sm:hover:border-blue-600 sm:hover:scale-105 transition ease-in-out duration-300`}
    >
      <h3 className="text-slate-800 font-bold text-xl">{projectTitle}</h3>
