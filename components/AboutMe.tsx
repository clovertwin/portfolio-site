const AboutMe = () => {
  return (
    ...
    >
      ...
      <div className="mt-5 p-4 border-2 transition ease-in-out duration-300 border-blue-600 rounded-2xl text-left bg-white shadow-lg text-neutral-600 sm:p-7 dark:border-sky-500 dark:bg-neutral-700 dark:text-neutral-50">
        <p>
