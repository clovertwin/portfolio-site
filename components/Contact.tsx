      ...
      >
        ...
        <div className="sm:flex sm:space-x-4 ">
          <div className="sm:w-1/2">
            <label className="text-slate-800 dark:text-neutral-50">Name</label>
            <input
          ...
          <div className="mt-6 sm:mt-0 sm:w-1/2">
            <label className="text-slate-800 dark:text-neutral-50">Email</label>
            <input
              value={userEmail}
        ...
        <div>
          <label className="text-slate-800 dark:text-neutral-50">Message</label>
          <textarea
            value={userMessage}
